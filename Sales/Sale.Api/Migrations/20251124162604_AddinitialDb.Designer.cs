...
namespace Sale.Api.Migrations
{
    ...
    [Migration("20251124162604_AddinitialDb")]
            ...
            modelBuilder.Entity("Sale.Share.Entities.ProductsubCategory", b =>
                {
                    ...
                    b.Property<int>("SubcategoryTranslationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubcategoryTranslationId");
            ...
            modelBuilder.Entity("Sale.Share.Entities.ProductsubCategory", b =>
                {
                    ...
                    b.HasOne("Sale.Share.Entities.SubcategoryTranslation", "SubcategoryTranslation")
                        .WithMany()
                        .HasForeignKey("SubcategoryTranslationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("SubcategoryTranslation");
                });
